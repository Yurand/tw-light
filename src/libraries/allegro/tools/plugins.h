...
/* registration code for setting up the filename conversion plugin */
{
   extern DATEDIT_MENU_INFO datfname_type_menu;

   datedit_register_menu(&datfname_type_menu);
}
...
/* registration code for setting up the most pointless plugin of all */
{
   extern DATEDIT_MENU_INFO datworms_menu;

   datedit_register_menu(&datworms_menu);
}
